...
const aboutLinks = [
  { href: "/about", label: "About Cryptinas" },
  { href: "/team", label: "The Team" },
  { href: "/college", label: "Hindusthan College" },
];

const eventLinks = [
  { href: "/events#paper-presentation", label: "Paper Presentation" },
  { href: "/events#project-expo", label: "Project Expo" },
  { href: "/events#coding-contest", label: "Coding Contest" },
  { href: "/events#web-design", label: "Web Design" },
];
    ...
    <footer className="m-1 rounded-3xl border">
      <div className="mx-auto max-w-5xl space-y-16 px-5 py-16">
        ...
        <div className="bg-muted mt-16 flex items-center justify-between rounded-md p-4 px-6 py-3">
          <span className="text-title">&copy; Cryptinas 2025</span>
          <Link
